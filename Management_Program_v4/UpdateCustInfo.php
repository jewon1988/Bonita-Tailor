...
if($_SESSION['loggedin']){
    ...
    <div class="bottom">
        ...
        <?php
        if($_POST['phoneNumber2Update'] || $_POST['typeUpdate'] || $_POST['productUpdate'] || $_POST['suitsFactoryUpdate'] || $_POST['fixDateUpdate'] || $_POST['factoryFinishDateUpdate'] || $_POST['settingDateUpdate'] || $_POST['supplyDateUpdate'] || $_POST['shootingDateUpdate'] || $_POST['marriageDateUpdate'] || $_POST['priceUpdate'] || $_POST['paidUpdate'] || $_POST['balanceUpdate']){
            ?>
            <div>
                <?php

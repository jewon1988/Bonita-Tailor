...
if($_SESSION['loggedin']){
    ...
    if(isset($_POST['insert'])){
        ...
        if($valid){
            ...
            $connection->insertDB( $custNum, $contractDate, $custName, $phoneNumber1, $phoneNumber2, $type, $product, $suitsFactory, $fixDate, $factoryFinishDate, $settingDate, $supplyDate, $shootingDate, $marriageDate, $price, $paid, $balance);

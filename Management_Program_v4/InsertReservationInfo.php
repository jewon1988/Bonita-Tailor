...
if($_SESSION['loggedin']){
    ...
    if(isset($_POST['insert'])){
        ...
        if($valid){
            ...
            $connection->insertReserveDB($reservationDate, $reservationTime, $custName, $phoneNumber1);
        ...
        <div>
            <form method="post" action="">
                <table class="table2">
                    <tr>
                        <td>예약일 : </td>
                        <td><input type="text" name="reservationDate" value="<?php if(!empty($_POST['reservationDate'])) echo $_POST['reservationDate']; ?>"> (예 : 2017-01-01)</td>

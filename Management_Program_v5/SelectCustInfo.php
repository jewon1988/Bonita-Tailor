...
if($_SESSION['loggedin']){
    ...
    if(isset($_POST['select5'])){
        if(empty($_POST['startFactoryFixDate']) || empty($_POST['lastFactoryFixDate'])){
            $factoryFixDateErr = "조회할 공장 가봉일을 입력하세요..";
            $valid = false;
        }
        if($_POST['startFactoryFixDate'] > $_POST['lastFactoryFixDate']){
            $factoryFixDateErr = "조회할 공장 가봉일의 입력이 잘 못되었습니다..";
            $valid = false;
        }
        ...
        if($valid){
            ...
            $startFactoryFixDate = $_POST['startFactoryFixDate'];
            $lastFactoryFixDate = $_POST['lastFactoryFixDate'];

            $connection->selectDB7($startFactoryFixDate, $lastFactoryFixDate);
        }
    }
    if($_POST['back']){
    ...
    <div class="bottom">
            ...
            <form method="post" action="">
                <table class="table2">
                    <tr>
                        <td>공장 가봉일 : </td>
                        <td>
                            <input type="text" name="startFactoryFixDate" value="<?php if(!empty($_POST['startFactoryFixDate'])) echo $_POST['startFactoryFixDate'];  ?>"> ~
                            <input type="text" name="lastFactoryFixDate" value="<?php if(!empty($_POST['lastFactoryFixDate'])) echo $_POST['lastFactoryFixDate'];  ?>"> (예 : 2017-01-01)
                        </td>
                        <td><?php echo $factoryFixDateErr; ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <input type="submit" name="select5" value="조 회">
        ...
        <?php
        if($_POST['select1'] || $_POST['select2'] || $_POST['select3'] || $_POST['select4'] || $_POST['select5']){
            ?>
            <div>
                <?php

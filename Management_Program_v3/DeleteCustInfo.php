...
if($_SESSION['loggedin']){
    ...
    if(isset($_POST['delete'])){
        ...
        if($valid){
            ...
            $connection->selectDB4($custNum, $custName, $phoneNumber1);
            ...
            if ($connection->valid == true && $connection->empty == true){
                ...
                $connection->deleteDB($custNum, $custName, $phoneNumber1);
                $message = $custName." 님의 정보가 성공적으로 삭제되었습니다..";
            }
        }
    }
    if($_POST['back']){
